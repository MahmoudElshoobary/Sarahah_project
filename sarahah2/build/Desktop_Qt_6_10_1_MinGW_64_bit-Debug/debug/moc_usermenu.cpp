...
template <> constexpr inline auto UserMenu::qt_create_metaobjectdata<qt_meta_tag_ZN8UserMenuE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        ...
        "on_msg_tab_clicked",
        "on_fav_tab_clicked",
        "on_send_msg_tab_clicked",
        "on_logoutButtent_clicked",
        "on_addcontact_btn_clicked",
        "on_sendButton_clicked",
        "populateContactsList",
        "populateReceivedMessagesList",
        "populateFavoriteMessagesList",
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'on_msg_tab_clicked'
        QtMocHelpers::SlotData<void()>(3, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_fav_tab_clicked'
        QtMocHelpers::SlotData<void()>(4, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_send_msg_tab_clicked'
        QtMocHelpers::SlotData<void()>(5, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_logoutButtent_clicked'
        QtMocHelpers::SlotData<void()>(6, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_addcontact_btn_clicked'
        QtMocHelpers::SlotData<void()>(7, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_sendButton_clicked'
        QtMocHelpers::SlotData<void()>(8, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'populateContactsList'
        QtMocHelpers::SlotData<void()>(9, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'populateReceivedMessagesList'
        QtMocHelpers::SlotData<void()>(10, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'populateFavoriteMessagesList'
        QtMocHelpers::SlotData<void()>(11, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_favoriteButton_clicked'
...
void UserMenu::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->on_msg_tab_clicked(); break;
        case 2: _t->on_fav_tab_clicked(); break;
        case 3: _t->on_send_msg_tab_clicked(); break;
        case 4: _t->on_logoutButtent_clicked(); break;
        case 5: _t->on_addcontact_btn_clicked(); break;
        case 6: _t->on_sendButton_clicked(); break;
        case 7: _t->populateContactsList(); break;
        case 8: _t->populateReceivedMessagesList(); break;
        case 9: _t->populateFavoriteMessagesList(); break;
        case 10: _t->on_favoriteButton_clicked(); break;
        default: ;
        }
    }
    (void)_a;
